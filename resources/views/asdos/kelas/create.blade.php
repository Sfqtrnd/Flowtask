...
@section('title', 'Tambah Kelas Praktikum - FlowTask')

@section('content')
<div class="px-6 py-4 max-w-2xl mx-auto">
  <h2 class="text-2xl font-semibold text-gray-800 mb-6">Tambah Kelas Praktikum</h2>
  ...
  <form action="{{ route('asdos.kelas.store') }}" method="POST">
    @csrf
