...
@section('title', 'Tambah Tugas Pribadi - FlowTask')

@section('content')
<div class="px-6 py-4 max-w-lg mx-auto">
  <h2 class="text-2xl font-semibold text-gray-800 mb-6">Tambah Tugas Pribadi</h2>
  ...
  <form action="{{ route('mahasiswa.personal-tasks.store') }}" method="POST">
    @csrf
    <div class="mb-4">
    ...
    <div class="mb-4">
      ...
      <textarea id="deskripsi" name="deskripsi" rows="4"
                class="w-full border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-indigo-400">{{ old('deskripsi') }}</textarea>
    </div>
    <div class="mb-4">
    ...
    <div class="flex justify-end">
      ...
      <button type="submit"
              class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg">Simpan</button>
    </div>
  </form>
</div>
@endsection
